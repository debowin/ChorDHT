...
public class JoinResponse implements org.apache.thrift.TBase<JoinResponse, JoinResponse._Fields>, java.io.Serializable, Cloneable, Comparable<JoinResponse> {
  ...
  private static final org.apache.thrift.protocol.TField NODE_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("nodeInfo", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public String nodeInfo; // required
  ...
  public JoinResponse setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public JoinResponse setNodeInfo(String nodeInfo) {
    this.nodeInfo = nodeInfo;
    return this;
  }
