...
public class NodeService {
  ...
  public interface Iface {
    ...
    public void updateSuccessor(String successor_) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void updateSuccessor(String successor_, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void updateSuccessor(String successor_) throws org.apache.thrift.TException
    {
      send_updateSuccessor(successor_);
      recv_updateSuccessor();
    }

    public void send_updateSuccessor(String successor_) throws org.apache.thrift.TException
    {
      updateSuccessor_args args = new updateSuccessor_args();
      args.setSuccessor_(successor_);
      sendBase("updateSuccessor", args);
    }

    public void recv_updateSuccessor() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void updateSuccessor(String successor_, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      updateSuccessor_call method_call = new updateSuccessor_call(successor_, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class updateSuccessor_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public updateSuccessor_call(String successor_, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      ...
      public void getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_updateSuccessor();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class updateSuccessor<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateSuccessor_args> {
      ...
      public updateSuccessor_result getResult(I iface, updateSuccessor_args args) throws org.apache.thrift.TException {
        updateSuccessor_result result = new updateSuccessor_result();
        iface.updateSuccessor(args.successor_);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class updateSuccessor<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, updateSuccessor_args, Void> {
      public updateSuccessor() {
        super("updateSuccessor");
      }
      ...
      public void start(I iface, updateSuccessor_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.updateSuccessor(args.successor_,resultHandler);
      }
    }
...
;
  ...
  public static class updateSuccessor_args implements org.apache.thrift.TBase<updateSuccessor_args, updateSuccessor_args._Fields>, java.io.Serializable, Cloneable, Comparable<updateSuccessor_args>   {
    ...
    private static final org.apache.thrift.protocol.TField SUCCESSOR__FIELD_DESC = new org.apache.thrift.protocol.TField("successor_", org.apache.thrift.protocol.TType.STRING, (short)1);
    ...
    public String successor_; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SUCCESSOR_((short)1, "successor_");
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.SUCCESSOR_, new org.apache.thrift.meta_data.FieldMetaData("successor_", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public updateSuccessor_args(updateSuccessor_args other) {
      if (other.isSetSuccessor_()) {
        this.successor_ = other.successor_;
      }
    }
    ...
    @Override
    public void clear() {
      this.successor_ = null;
    }

    public String getSuccessor_() {
      return this.successor_;
    }

    public updateSuccessor_args setSuccessor_(String successor_) {
      this.successor_ = successor_;
      return this;
    }

    public void unsetSuccessor_() {
      this.successor_ = null;
    }

    /** Returns true if field successor_ is set (has been assigned a value) and false otherwise */
    public boolean isSetSuccessor_() {
      return this.successor_ != null;
    }

    public void setSuccessor_IsSet(boolean value) {
      if (!value) {
        this.successor_ = null;
      }
    }
    ...
    public boolean equals(updateSuccessor_args that) {
      ...
      boolean this_present_successor_ = true && this.isSetSuccessor_();
      boolean that_present_successor_ = true && that.isSetSuccessor_();
      if (this_present_successor_ || that_present_successor_) {
        if (!(this_present_successor_ && that_present_successor_))
          return false;
        if (!this.successor_.equals(that.successor_))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_successor_ = true && (isSetSuccessor_());
      list.add(present_successor_);
      if (present_successor_)
        list.add(successor_);
    ...
    public int compareTo(updateSuccessor_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetSuccessor_()).compareTo(other.isSetSuccessor_());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSuccessor_()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.successor_, other.successor_);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("successor_:");
      if (this.successor_ == null) {
        sb.append("null");
      } else {
        sb.append(this.successor_);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class updateSuccessor_argsStandardScheme extends StandardScheme<updateSuccessor_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, updateSuccessor_args struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // SUCCESSOR_
              if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
                struct.successor_ = iprot.readString();
                struct.setSuccessor_IsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateSuccessor_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeStructBegin(STRUCT_DESC);
        if (struct.successor_ != null) {
          oprot.writeFieldBegin(SUCCESSOR__FIELD_DESC);
          oprot.writeString(struct.successor_);
          oprot.writeFieldEnd();
        }
        oprot.writeFieldStop();
        oprot.writeStructEnd();
